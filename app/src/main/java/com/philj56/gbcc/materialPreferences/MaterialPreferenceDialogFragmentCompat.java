/*
 * This file is a copy of the corresponding androidx preference file,
 * modified solely to use MaterialAlertDialogBuilder in order to get
 * pretty dialogs. This appears to be the only way to achieve this -
